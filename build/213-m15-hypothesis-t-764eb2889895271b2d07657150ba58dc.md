...
```{admonition} Example
    ...
    and as the figure reminds us, we took a sample of 1,000 U.S. adults, and the data told us that 675 supported the death penalty for convicted murderers (i.e. $\overset{ˆ}{p}=.675$).
...
```{admonition} Example
    ...
    The data we have are that out of n=80 tosses, we got 48 heads, or that the sample proportion of heads is:$\overset{ˆ}{p}=\frac{48}{80}=.6$
