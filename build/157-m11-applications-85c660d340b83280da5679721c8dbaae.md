...
```{admonition} Example: Male Foot Length
    1. Male foot lengths have a normal distribution, with $μ=11,σ=1.5$ inches. What is the probability of a foot length of more than 13
                            inches? First, we standardize: $z=\frac{x-μ}{σ}=\frac{13-11}{1.5}=+1.33$; the probability that we seek, P(X > 13), is the same as the
