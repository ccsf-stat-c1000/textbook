...
```{admonition} Example
    Approximately 60% of all part-time college students in the United States are female. (In other words, the population proportion of females among part-time college students is p = .6.) What would you expect to see in terms of the behavior of sample proportion of females ($\overset{ˆ}{p}$) if random samples of size 100 were taken from the population of all part-time college students?
    ...
    *Center*: Some sample proportions will be on the low sidesay, .55 or .58— while others will be on the high side— say, .61 or .66. It is reasonable to expect all the sample proportions in repeated random samples to average out to the underlying population proportion, .6. In other words, the mean of the distribution of $\overset{ˆ}{p}$ should be p.
...
The *distribution* of the values of the sample proportions ($\overset{ˆ}{p}$) in repeated *samples* is called the *sampling distribution of* $\overset{ˆ}{p}$.

The purpose of the next activity is to check whether our intuition about the center, spread and shape of the sampling distribution of $\overset{ˆ}{p}$ was right via simulations.
