...
The test statistic is $t=\frac{\bar{x}−μ_{0}}{\frac{s}{\sqrt{n}}}=\frac{550−500}{\frac{100}{\sqrt{4}}}=1$
...
The test statistic is: $t=\frac{\bar{x}−μ_{0}}{\frac{s}{\sqrt{n}}}=\frac{247−250}{\frac{12}{\sqrt{100}}}=−2.5$
...
$z=\frac{\bar{X}−μ_{0}}{\frac{σ}{\sqrt{n}}}$
...
8. Confidence intervals can be used to carry out the two-sided test $H_{a}:μ\neqμ_{0}$, and in cases where H~o~ is rejected, the confidence interval can give insight into the value of the population mean ($μ$).
