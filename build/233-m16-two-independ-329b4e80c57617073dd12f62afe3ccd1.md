...
Let's see why this test statistic makes sense, bearing in mind that our inference is about $μ_{1}−μ_{2}$.

- $\bar{y_{1}}$ estimates μ~1~ and $\bar{y_{2}}$ estimates μ~2~, and therefore $\bar{y_{1}}− \bar{y_{2}}$ is what the data tell me about (or, how the data estimate) $μ_{1}−μ_{2}$.
- 0 is the "null value" — what the null hypothesis, H~o~, claims that $μ_{1}−μ_{2}$ is.
...
and therefore, like the previous test statistics, measures (in standard errors) the difference between what the data tell us about the parameter of interest $μ_{1}−μ_{2}$ (sample estimate) and what the null hypothesis claims the value of the parameter is (null value).
...
```{admonition} Example
    ...
    The test statistic tells us what the data tell us about $μ_{1}−μ_{2}$. In this case that difference (10.73 - 13.33) is 4.66 standard errors below what the null hypothesis claims this difference to be (0). 4.66 standard errors is quite a lot and probably indicates that the data provide evidence against H~o~.
```
