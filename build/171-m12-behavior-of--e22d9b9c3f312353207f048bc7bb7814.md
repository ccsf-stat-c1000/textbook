...
| Quantitative (example: age) | μ = population mean, σ = population standard deviation | $\bar{x}$ = sample mean | μ | $\frac{σ}{\sqrt{n}}$ | Normal if n > 30 (always normal if population is normal) |  |  |  |  |
