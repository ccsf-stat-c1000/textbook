...
The convention is to denote a value of our normal random variable X with the letter "x." Since the mean is written $μ$ and the standard deviation $σ$, we may write the standardized value as $z=\frac{x−μ}{σ}$
