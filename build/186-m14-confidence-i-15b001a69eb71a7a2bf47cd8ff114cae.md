...
To start our discussion about the structure of the confidence interval, let's denote the $z^{*}⋅\frac{σ}{\sqrt{n}}$ formula by m.
...
$\frac{σ}{\sqrt{n}}$, which is the standard deviation of $\bar{X}$, the point estimator of μ.
