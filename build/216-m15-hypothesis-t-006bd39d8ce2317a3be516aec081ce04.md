...
The test statistic is the z-score (standardized value) of the sample mean ($\bar{x}$) assuming that H~o~ is true (in other words, assuming that $μ=μ_{0}$).
...
- Spread: The standard deviation of the sample means is $\frac{σ}{\sqrt{n}}$.
