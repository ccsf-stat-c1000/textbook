...
```{admonition} Example: 2
    ...
    *Comment:*
    ...
    Here it is not that clear why the assumption that σ is known to be 12 is reasonable. If shipments are checked on a regular basis, then maybe past experience has shown that indeed $σ=12$. In any case, we will come back to this problem and discuss this point again later.
