...
As we did for the mean, the assumption we made in order to develop the methods in this unit was that the sampling distribution of the sample proportion, $\overset{ˆ}{p}$, is roughly normal. Recall from module 4 of the Probability unit that the conditions under which this happens are that $n⋅p\geq10$ and $n⋅\left(1−p\right)\geq10$. Since p is unknown, we will replace it with its estimate, the sample proportion, and set

$n⋅\overset{ˆ}{p}\geq10$ and $n⋅\left(1−\overset{ˆ}{p}\right)\geq10$

to be the conditions under which it is safe to use the methods we developed in this section.

## Let's Summarize

In general, a confidence interval for the unknown population proportion (p) is $\overset{ˆ}{p}\pmz^{*}⋅\sqrt{\frac{\overset{ˆ}{p}\left(1−\overset{ˆ}{p}\right)}{n}}$, where z* is 1.645 for 90% confidence, 2 for 95% confidence, and 2.576 for 99% confidence.
...
The methods developed in this unit are safe to use as long as $n⋅\overset{ˆ}{p}\geq10$ and $n⋅\left(1−\overset{ˆ}{p}\right)\geq10$ .
