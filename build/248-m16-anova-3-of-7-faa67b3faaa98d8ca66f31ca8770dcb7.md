...
Let's think about how we would go about testing whether the population means $μ_{1},μ_{2},μ_{3},μ_{4}$ are equal. It seems as if the best we could do is to calculate their point estimates—the sample mean in each of our 4 samples (denote them by $\bar{y_{1}},\bar{y_{2}},\bar{y_{3}},\bar{y_{4}}$),
