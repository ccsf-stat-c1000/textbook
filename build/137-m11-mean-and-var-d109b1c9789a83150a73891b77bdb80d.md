...
```{admonition} Example: Pizza Delivery #1
    ...
    Find the mean gain per pizza, $μ_{X}$.
...
```{admonition} Example: Pizza Delivery #2
    ...
    Next, setting $μ_{X}$ equal to +3.90 instead of +3, we solve
...
```{admonition} Example: Raffle
    ...
    $μ_{X}=E(X)=20(\frac{10}{2000})+45(\frac{5}{2000})+195(\frac{2}{2000})+1495(\frac{1}{2000})+(-5)(\frac{1982}{2000})$
